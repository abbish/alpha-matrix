  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">交易概览</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        />
        <StrategyStats title="新策略" count="438" icon="plus-circle" color="bg-red-100" iconColor="text-red-600" />
        <StrategyStats
          title="已完成策略"
          count="9,582"
          icon="check-circle"
        ...
        />
        <StrategyStats title="进行中策略" count="2,412" icon="clock" color="bg-blue-100" iconColor="text-blue-600" />
        <StrategyStats
          title="交易计划"
          count="1,287"
          icon="clipboard"
